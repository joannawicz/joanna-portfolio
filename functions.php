...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('large', 300, 900, true);
	add_image_size('full', 921, 588, true);
...
function hackeryou_widgets_init() {
	...
	register_sidebar( array(
		'name' => 'Tool Widget Area',
		'id' => 'tool-widget-area',
		'description' => 'The tool widget area',
		'class' => 'tool-widget',
	) );

	register_sidebar( array(
		'name' => 'DesignTool Widget Area',
		'id' => 'design-widget-area',
		'description' => 'The design tool widget area',
		'class' => 'design-widget',
	) );
